...
/*Liang.Huang@MULTIMEDIA.AUDIODRIVER.MACHINE, 2021/09/13, tfa98xx Speaker protection algorithm upgrade*/
...
/* Kai.Lv@MULTIMEDIA.AUDIODRIVER.FEATURE, 2020/10/09, Add for ear protection */
...
#ifdef OPLUS_ARCH_EXTENDS
/*Liang.Huang@MM.Audio.Driver,2021/08/16,modified for tfa98xx default 4PA tdm audio bringup*/
...
static void extend_codec_be_dailink(struct codec_prop_info *codec_info, struct snd_soc_dai_link *dailink, size_t size)
{
	...
	if (!strcmp(codec_info->codec_vendor, extend_codec_vendor[CODEC_VENDOR_NXP])) {
		...
		#ifdef OPLUS_ARCH_EXTENDS
		/*Liang.Huang@MM.Audio.Driver,2021/08/16,modified for tdm audio bringup*/
