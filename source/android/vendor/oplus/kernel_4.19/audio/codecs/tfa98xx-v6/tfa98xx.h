...
#ifdef OPLUS_ARCH_EXTENDS
/*Liang.Huang@MM.Audio.Driver,2021/08/16,modified for pad tdm pa count*/
#define CHIP_4PA_COUNT    (4)
/*Liang.Huang@MM.Audio.Driver,2021/08/16,modified for pad tdm chip select*/
...
/*Liang.Huang@MM.Audio.Driver,2021/08/16,modified for pad tdm device i2c address*/
