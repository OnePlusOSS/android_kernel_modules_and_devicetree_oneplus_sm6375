...
static int tfa98xx_send_volume(uint8_t channel, uint8_t volume)
{
	...
	#ifdef OPLUS_ARCH_EXTENDS
	/*WeiJie.Zhou@MM.Audio.Driver,2021/09/26,modified for audio bringup*/
...
#ifdef OPLUS_ARCH_EXTENDS
/*Liang.Huang@MM.Audio.Driver,2021/09/07,modified for pad tdm device multi speaker*/
...
static int tfa98xx_create_controls(struct tfa98xx *tfa98xx)
{
	...
	if (tfa98xx_device_count == CHIP_4PA_COUNT) {
		/*Liang.Huang@PSW.MM.AudioDriver.SmartPA, 2021/09/09, Add for multi speaker*/
