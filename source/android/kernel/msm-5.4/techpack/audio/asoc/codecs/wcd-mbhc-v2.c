...
out_micb_en:
	...
	case WCD_EVENT_POST_MICBIAS_2_OFF:
		...
		if ((test_bit(WCD_MBHC_EVENT_PA_HPHL, &mbhc->event_state)) ||
			...
			/* Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2017/04/10,
				 ...
				 bool enable)
{
	...
	/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2019/09/25, Add for log*/
				...
				enum snd_jack_types jack_type)
{
	...
	if (!insertion) {
		...
		if (wcd_cancel_btn_work(mbhc)) {
			...
			#ifndef OPLUS_ARCH_EXTENDS
			/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2017/03/03,
			...
			pr_info("%s: release of button press%d\n",
				 __func__, jack_type);
			/* Ming.Liu@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2017/07/12,
		...
		mbhc->zl = mbhc->zr = 0;
		#ifndef OPLUS_ARCH_EXTENDS
		/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET 2016/01/01,
				   ...
				   enum wcd_mbhc_plug_type plug_type)
{
	...
	#ifndef OPLUS_ARCH_EXTENDS
	/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2016/01/01, Modify for necessary log*/
...
static void wcd_mbhc_swch_irq_handler(struct wcd_mbhc *mbhc)
{
	...
	enum snd_jack_types jack_type;
	#ifdef OPLUS_ARCH_EXTENDS
	/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETDET, 2021/03/23,
	 *Add for micbias2.
	 */
	bool micbias2 = false;
	#endif /* OPLUS_ARCH_EXTENDS */
	...
	#ifdef OPLUS_ARCH_EXTENDS
	/*Nan.Zhong@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2019/11/01, Add for Headset detect*/
	...
	#endif /* OPLUS_ARCH_EXTENDS */
#ifdef OPLUS_ARCH_EXTENDS
/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2016/09/26,
...
#define dev_dbg dev_info
	...
	if ((mbhc->current_plug == MBHC_PLUG_TYPE_NONE) &&
		...
		#ifndef OPLUS_ARCH_EXTENDS
		/*Nan.Zhong@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2019/11/01, Modify for headset detect*/
		if (mbhc->mbhc_fn)
...
#define pr_debug pr_info
	...
	if (mbhc->mbhc_detection_logic == WCD_DETECTION_LEGACY &&
		mbhc->current_plug == MBHC_PLUG_TYPE_HEADPHONE) {
		#ifndef OPLUS_ARCH_EXTENDS
		/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2017/04/15,
...
static int wcd_mbhc_initialise(struct wcd_mbhc *mbhc)
{
	...
	if (mbhc->mbhc_cb->hph_pull_up_control_v2)
		...
		#ifndef OPLUS_ARCH_EXTENDS
		/* Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET.1473948, 2018/07/09,
					   ...
					   unsigned long mode, void *ptr)
{
	...
	#ifndef OPLUS_ARCH_EXTENDS
	/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2019/08/26, Modify for log*/
		      ...
		      bool impedance_det_en)
{
	...
	#ifdef OPLUS_ARCH_EXTENDS
	/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETSET, 2019/09/25,
	...
	#ifdef OPLUS_ARCH_EXTENDS
	/*Le.Li@MULTIMEDIA.AUDIODRIVER.HEADSETDET, 2020/11/10,
	 *Add for mbhc cross connection.
	 */
